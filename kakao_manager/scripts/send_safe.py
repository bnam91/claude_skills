...
Usage:
  send_safe.py "<채팅방명>" --text "메시지" --verify-me
  send_safe.py "<채팅방명>" --image <path>.png --verify-me
  send_safe.py "<채팅방명>" --file <path>.pdf --verify-me
  send_safe.py "<단톡방명>" --text "안녕하세요"  # 괄호 자동 우회
"""
